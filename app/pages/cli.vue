<template>
	<main class="relative mb-16 flex w-full flex-col items-center justify-center gap-20 duration-200 ease-in-out max-md:mb-8 max-md:gap-12">
		<section class="from-bluegray-50 to-bluegray-0 relative flex w-full flex-col items-center overflow-hidden bg-linear-to-tr from-50%">
			...
			<div class="absolute inset-x-0 bottom-0 h-[100px] w-full opacity-80">
				<span class="animate-swap-primary-blue absolute inset-x-0 bottom-0 mx-auto h-[120px] w-[600px] translate-x-1/2 translate-y-3/5 rounded-full blur-3xl max-md:w-[400px] max-md:translate-x-full"/>
				<span class="animate-swap-blue-primary absolute inset-x-0 bottom-0 mx-auto h-[120px] w-[600px] translate-y-3/5 rounded-full blur-3xl max-md:w-[400px]"/>
				<span class="animate-swap-primary-blue absolute inset-x-0 bottom-0 mx-auto h-[120px] w-[600px] -translate-x-1/2 translate-y-3/5 rounded-full blur-3xl max-md:w-[400px] max-md:-translate-x-full"/>
				<span class="animate-swap-blue-primary absolute inset-x-0 bottom-0 h-4 w-full translate-y-1/2 rounded-full blur-2xl"/>
			</div>
		</section>
		...
		<section class="max-w-section relative flex flex-col items-center gap-6 max-md:px-2">
